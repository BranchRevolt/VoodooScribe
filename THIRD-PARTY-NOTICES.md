...
All bundled dependencies are under permissive or GPL-compatible licenses. There
is no license conflict: GPLv3 was chosen specifically because a large part of
...
| **llama.cpp** + **ggml** (summarization / punctuation) | MIT | <https://github.com/ggml-org/llama.cpp>, linked via `llama-cpp-2` (MIT OR Apache-2.0) |
...
**Silero VAD**, at `src-tauri/resources/models/ggml-silero-v5.1.2.bin` (~865 KB),
...
**FFmpeg**, shipped as a separate `ffmpeg` sidecar process and used as a universal
...
Both are compatible with this program's GPL-3.0-or-later license (GPL-2.0-**or-later**
...
packages carry other licenses (for example `caniuse-lite`, CC-BY-4.0); none of

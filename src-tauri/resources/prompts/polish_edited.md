...
- Keep the original language: Russian stays Russian, English stays English. Do NOT translate anything.
- Remove filler and stumbles inside a line: "э-э", "ну", "как бы", "uh", "um", false starts, a word repeated twice in a row. If a line is nothing but filler, return it unchanged rather than emptying it.
